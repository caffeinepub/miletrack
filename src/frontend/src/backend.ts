...
export class Backend implements backendInterface {
    ...
    async addTrip(arg0: string, arg1: string, arg2: string, arg3: number): Promise<TripId> {
        if (this.processError) {
            try {
    ...
    async deleteTrip(arg0: TripId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getTripStats(): Promise<TripStats> {
        if (this.processError) {
            try {
                const result = await this.actor.getTripStats();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTripsByUser(arg0: Principal): Promise<Array<Trip>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTripsByUser(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTrip(arg0: Trip): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTrip(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
